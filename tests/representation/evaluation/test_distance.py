...
def test_compute_track_displacement_numerical():
    ...
    result_sqeuclidean = compute_track_displacement(dataset, distance_metric="sqeuclidean")
    ...
    assert np.allclose(sorted(result_cosine[1]), sorted(expected_cosine_tau1), atol=1e-10)
