        ...
        for b in range(batch_size):
            if self.R.rand() < self.prob:
                ...
                for i in range(num_patches):
                    ...
                    patch = result[b, :, z:z+self.patch_size, y:y+self.patch_size, x:x+self.patch_size]
                    ...
                    result[b, :, z:z+self.patch_size, y:y+self.patch_size, x:x+self.patch_size] = shuffled_patch
