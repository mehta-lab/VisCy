...
SAMPLE_AIRTABLE_RECORDS = [
    {
        ...
        "fields": {
            ...
            "microscope": {"name": "mantis"},
            "labelfree_modality": {"name": "widefield"},
            "treatment": {"name": "DMSO"},
            "hours post treatment": 2.0,
            "t_shape": 50,
            "c_shape": 2,
            "z_shape": 30,
            "y_shape": 2048,
    ...
    },
    {
        ...
        "fields": {
            ...
            "microscope": "dragonfly",
            "labelfree_modality": "oblique",
            "treatment": None,
            "hours post treatment": None,
            "t_shape": 100,
            "c_shape": 2,
            "z_shape": 15,
            "y_shape": 1024,
