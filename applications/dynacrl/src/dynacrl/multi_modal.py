"""Joint contrastive module for cross-modal learning."""
...
class JointEncoders(nn.Module):
    """Paired encoders for cross-modal contrastive learning."""
...
class JointContrastiveModule(ContrastiveModule):
    """CLIP-style model pair for cross-modality representation learning."""
