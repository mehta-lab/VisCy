"""Classification module for linear probing of learned representations."""
...
class ClassificationPredictionWriter(BasePredictionWriter):
    """Writer callback for saving classification predictions."""
...
class ClassificationModule(LightningModule):
    """Binary classification module for linear probing.
    ...
    loss : nn.Module, optional
        Loss function, by default BCEWithLogitsLoss.
    example_input_array_shape : tuple, optional
