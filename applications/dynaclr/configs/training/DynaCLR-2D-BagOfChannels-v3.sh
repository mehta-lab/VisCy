...
#
# New run:
#   sbatch applications/dynaclr/configs/training/DynaCLR-2D-BagOfChannels-v3.sh
#
...
export CONFIGS="applications/dynaclr/configs/training/DynaCLR-2D-BagOfChannels-v3.yml"
