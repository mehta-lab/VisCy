...
#
# New run:
#   sbatch applications/dynaclr/configs/training/DINOv3-temporal-MLP-2D-BagOfChannels.sh
#
...
export CONFIGS="applications/dynaclr/configs/training/DINOv3-temporal-MLP-2D-BagOfChannels.yml"
