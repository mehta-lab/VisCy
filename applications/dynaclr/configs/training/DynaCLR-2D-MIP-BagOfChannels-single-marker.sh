...
#
#   sbatch applications/dynaclr/configs/training/DynaCLR-2D-MIP-BagOfChannels-single-marker.sh
...
export CONFIGS="applications/dynaclr/configs/training/DynaCLR-2D-MIP-BagOfChannels.yml applications/dynaclr/configs/training/DynaCLR-2D-MIP-BagOfChannels-single-marker.yml"
