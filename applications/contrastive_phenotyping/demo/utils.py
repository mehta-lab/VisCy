...
def create_combined_visualization(
    ...
    print(f"Using {len(all_timepoints)} timepoints for visualization")

    # Function to create PHATE plot traces
    def create_phate_traces(df, t, df_coordinates=["PHATE1", "PHATE2"]):
    ...
    main_fig.update_layout(
        title=f"Combined Visualization - Time: {t_initial}",
        width=plot_size_xy[0],
        height=plot_size_xy[1],
        updatemenus=[
            {
