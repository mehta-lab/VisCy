...
mean_displacement_30_min_cosine, std_displacement_30_min_cosine = compute_displacement_mean_std(embedding_dataset_30_min, max_tau, use_cosine=True, use_dissimilarity=False)
mean_displacement_no_track_cosine, std_displacement_no_track_cosine = compute_displacement_mean_std(embedding_dataset_no_track, max_tau, use_cosine=True, use_dissimilarity=False)
...
def compute_umap(dataset):
    ...
    umap_features = features.assign_coords(UMAP1=("sample", embedding[:, 0]), UMAP2=("sample", embedding[:, 1]))
