...
plt.tight_layout()
plt.savefig(
    "/hpc/projects/comp.micro/infected_cell_imaging/Single_cell_phenotyping/ContrastiveLearning/Figure_panels/arXiv_rev2/ALFI/phatemap_timeinterval_ALFI.pdf",
    dpi=300,
)
...
features_timeaware = np.concatenate(
    [features_train_timeaware, features_test_timeaware], axis=0
)
features_classical = np.concatenate(
    [features_train_classical, features_test_classical], axis=0
)
...
conditions = [
    ...
    (
        fov_name_test_mitosis,
        track_id_test_mitosis,
        t_test_mitosis,
        test_data_path,
        test_track_path,
        cell_type_test_mitosis,
    ),
    (
        fov_name_test_interphase,
        track_id_test_interphase,
        t_test_interphase,
        test_data_path,
        test_track_path,
        cell_type_test_interphase,
    ),
    (
        fov_name_train_mitosis,
        track_id_train_mitosis,
        t_train_mitosis,
        train_data_path,
        train_track_path,
        cell_type_train_mitosis,
    ),
    (
        fov_name_train_interphase,
        track_id_train_interphase,
        t_train_interphase,
        train_data_path,
        train_track_path,
        cell_type_train_interphase,
    ),
]
...
for fov_name, track_id, t, data_path, track_path, name in conditions:
    dic_images[name] = load_track_images(
        data_path, track_path, t, fov_name, track_id[0]
    )
...
plt.scatter(
    phate_embedding_timeaware[:, 0],
    phate_embedding_timeaware[:, 1],
    c=division.map(color_map),
    alpha=0.7,
    s=40,
    edgecolor="white",
    linewidth=0.5,
)  # Add white edges to points
for fov_name, track_id, t, data_path, track_path, name in conditions:
    ...
    if not highlight_data.empty:
        ax1.scatter(
            ...
            c=highlight_data["cell_type"].map(color_map),
            alpha=0.7,
            s=500,
            edgecolor="black",
            linewidth=2,
...
plt.tight_layout()
plt.savefig(
    "/hpc/projects/comp.micro/infected_cell_imaging/Single_cell_phenotyping/ContrastiveLearning/Figure_panels/arXiv_rev2/ALFI/phatemap_joint_ALFI_timeaware_wImages.pdf",
    dpi=300,
)
...
plt.yticks([])
plt.savefig(
    "/hpc/projects/comp.micro/infected_cell_imaging/Single_cell_phenotyping/ContrastiveLearning/Figure_panels/arXiv_rev2/ALFI/phatemap_joint_ALFI_timeaware_wImages_scatterplot.png",
    dpi=300,
)
...
plt.tight_layout()
plt.savefig(
    "/hpc/projects/comp.micro/infected_cell_imaging/Single_cell_phenotyping/ContrastiveLearning/Figure_panels/arXiv_rev2/ALFI/phatemap_joint_ALFI_timeaware_wImages_images.pdf",
    dpi=300,
)
