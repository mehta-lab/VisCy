"""
Example configuration for PHATE Track Viewer.

Edit this file to customize dataset paths, FOV filters, annotation settings,
and visualization parameters for your own data.
"""
