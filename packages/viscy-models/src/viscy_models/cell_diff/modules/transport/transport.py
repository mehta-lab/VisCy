...
class ModelType(enum.Enum):
    ...
    DENOISED = enum.auto() # the model predicts denoised x1 from xt
...
class Transport:
    ...
    def get_drift(
        ...
        def denoised_ode(x, t, model, **model_kwargs):
            ...
            x1_hat = model(x, t, **model_kwargs)  # denoised/data prediction: \hat x_1
    ...
    def get_score(
        ...
        if self.model_type == ModelType.NOISE:
            ...
            score_fn = lambda x, t, model, **kwargs: self.path_sampler.get_score_from_denoised(model(x, t, **kwargs), x, t)
        else:
            raise NotImplementedError()
