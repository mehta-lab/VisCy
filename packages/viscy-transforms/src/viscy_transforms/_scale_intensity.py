"""Batch-aware intensity scaling transforms."""
...
__all__ = ["BatchedRandScaleIntensity", "BatchedRandScaleIntensityd"]
...
class BatchedRandScaleIntensity(RandomizableTransform):
    ...
    def randomize(self, data: Tensor) -> None:
        ...
        if self.channel_wise and data.ndim > 2:
            ...
            shape = (batch_size,)
        factors = torch.empty(shape, device=data.device).uniform_(factors_min, factors_max)
