...
# ---------------------------------------------------------------------------
# Test 3: __all__ count pinned at 54
# ---------------------------------------------------------------------------


def test_all_count():
    """__all__ contains exactly 54 names (detect accidental add/remove)."""
    assert len(viscy_data.__all__) == 54, f"Expected 54 names in __all__, got {len(viscy_data.__all__)}"
