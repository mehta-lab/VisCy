...
from viscy_data.gpu_aug import CachedOmeZarrDataset, GPUTransformDataModule
...
class CTMCv1DataModule(GPUTransformDataModule):
    ...
    def _setup_fit(self) -> None:
        ...
        subsample_indices = list(range(0, len(full_val_dataset), self.val_subsample_ratio))
